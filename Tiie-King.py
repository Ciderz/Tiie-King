...
try:
    ...
    os.system('python2 Tumisorsa.py')
...
║╚╩═║╔═╗║║─║║║╚╩═║
╚═══╩╝─╚╩╝─╚═╩═══╝
\033[1;95m●●●●●●●DEV BY TYLOR GANG●●●●●●●

\033[1;96m▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
 
\033[1;93m★ Auther : ƬƛƳԼƠƦ ƓƛƝƓ
\033[1;93m★ W/A    : +27812145320
\033[1;93m★ Github : TumisoRSA
...
def menu():
	...
	print (S + '☛ ' + G + 'Target iD: ' + R + a['id'])
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '✟1' + S + ']' + S + ' FᴀsᴛCʟᴏɴɪɴɢ')
	print (S + '[' + P + '✟2' + S + ']' + S + ' Uᴘᴅᴀᴛɪɴɢ')
	print (S + '[' + P + '✟3' + S + ']' + S + ' Tʏʟᴏʀ Gᴀɴɢ')
	print (S + '[' + Y + '✟4' + S + ']' + G + ' Lᴏɢ Oᴜᴛ')
	print (S + '[' + Y + '✟0' + S + ']' + R + ' Exɪᴛ')
	print
	print (S + 50*'-')
	print
	mb()
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Tylor-pakistsni')
	    os.system('cd $HOME && git clone http://github.com/tumiso258/tiepecy.git/')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('facebook id TʏʟᴏʀGᴀɴɢ✓')
	    psb('WellCome To Tumisp-pakistani')
	    psb('Congratulations Tᴀʏʟᴏʀ GᴀɴɢTool Has Been Updated Successfully')
	    psb('🔓User Name☆ trazim✓')
	    psb('🔓Password ☆ tiepecy✓')
	    psb('Subscrib My Youtube Chenal TumisoRsa✓')
...
def pak():
	...
	cb()
	print (logo)
	print (S + '[' + P + '✟1' + S + ']' + P + ' Cʟᴏɴᴇ Fʀɪᴇɴᴅs Lɪsᴛ')
	print (S + '[' + P + '✟2' + S + ']' + P + ' Cʟᴏɴᴇ Pᴜʙʟɪᴄᴋ Iᴅ Lɪsᴛ')
	print (S + '[' + Y + '✟3' + S + ']' + Y + ' Cloɴᴇ Fʀᴏᴍ Fᴏʟʟᴏᴡᴇʀs')
	print (S + '[' + R + '✟0' + S + ']' + R + ' Bᴀᴄᴋ')
	print
	print (S + 50*'-')
	print
	pb()
...
def pb():
	...
	psb(S + '☛' + S + ' To stop process  Press CTRL ~ Z')
	print
	print (S + 50*'-')
	print
	def main(arg):
